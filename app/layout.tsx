...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://bokeppaksa.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "name": `${SITENAME}`,
        "description": `${SITENAME} Video bokep indo jepang indonesia barat terbaru viral korea simontok china tante live sma paksa ngentot abg jilbab cewek bocil smp pijat pelajar.`,
        "logo": "https://bokeppaksa.pages.dev/favicon.ico",
        "url": "https://bokeppaksa.pages.dev",
        "founder":{
            "@type":"Person",
            "name":"admin",
            "url":"https://bokeppaksa.pages.dev"
        ...
        "url": "https://bokeppaksa.pages.dev",
        "description": `${SITENAME} Video bokep indo jepang indonesia barat terbaru viral korea simontok china tante live sma paksa ngentot abg jilbab cewek bocil smp pijat pelajar.`,
        "image": "https://bokeppaksa.pages.dev/favicon.ico",
        "potentialAction":{
            "@type":"ReadAction",
            "target":"https://bokeppaksa.pages.dev/"}
        }
        const jsonLd2 = {
            "@context": "https://schema.org",
        "@type": "WebSite",
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://bokeppaksa.pages.dev/?q={search_term}", 
